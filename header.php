			...
			<header id="masthead" class="container site-header">
				...
				<nav id="site-navigation" class="main-navigation">
					...
					<div class="site-menus" id="mastmenus">
						...
						<img src="<?php echo get_template_directory_uri(); ?>/img/rodchenkchose_1.png" class="img-menu-deco" alt="decoration"> 
